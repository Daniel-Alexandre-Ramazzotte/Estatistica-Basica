# QUESTÕES DE ESTATÍSTICA BÁSICA
...
Para encontrar a [mediana](https://brasilescola.uol.com.br/matematica/mediana.htm), colocaremos os dados em ordem:
...
A alternativa que melhor define a [estatística](https://brasilescola.uol.com.br/matematica/estatistica-2.htm) é a terceira.
...
Na construção de classes para uma variável contínua, o livro usa a notação a — b para um intervalo. O que ela significa?  
A) Intervalo aberto (a, b), sem conter extremos.  
B) Intervalo fechado \[a, b\], contendo ambos extremos.  
C) Intervalo que contém a, mas não contém b (equivalente a \[a, b)).  
D) Intervalo que contém b, mas não contém a (equivalente a (a, b\]).  
E) Intervalo que contém a e b apenas se forem inteiros.  
RESPOSTA: C  
O texto afirma explicitamente que a — b contém o extremo a e não contém o extremo b,  
podendo ser escrito como \[a, b).

QUESTÃO 14 

Considere a tabela de classes (em salários mínimos) com frequências absolutas: 4—8: 10; 8—12: 12; 12—16: 8; 16—20: 5; 20—24: 1 (n=36). Qual é a porcentagem acumulada até a classe 12—16?  
A) 22,22%   
B) 27,78%   
C) 61,11%   
D) 83,33%   
E) 97,22%  
RESPOSTA: D   
Até 12—16 acumulamos 10+12+8=30 observações.  
Logo, porcentagem acumulada \= 100·30/36 \= 83,33%

QUESTÃO 15 

Em um histograma com classes de amplitudes possivelmente diferentes, o livro recomenda que a altura do retângulo da i-ésima classe seja proporcional a:   
A) ni   
B) fi   
C) Δi/fi   
D) fi/Δi (ou ni/Δi)   
E) (ni·Δi)   
RESPOSTA: D   
Para que a área de cada retângulo seja proporcional à frequência relativa fi, a altura deve ser proporcional a fi/Δi (ou ni/Δi). Assim a área total pode ser 1\. 

QUESTÃO 16 

Uma pesquisa coleta as seguintes variáveis: (i) estado civil (solteiro, casado, etc.); (ii) número de filhos; (iii) altura (em cm). Assinale a alternativa que classifica corretamente (i), (ii) e (iii).   
A) (i) qualitativa nominal; (ii) quantitativa discreta; (iii) quantitativa contínua.   
B) (i) qualitativa ordinal; (ii) quantitativa contínua; (iii) quantitativa discreta.   
C) (i) quantitativa discreta; (ii) qualitativa nominal; (iii) quantitativa contínua.   
D) (i) qualitativa nominal; (ii) qualitativa ordinal; (iii) quantitativa discreta.   
E) (i) qualitativa ordinal; (ii) quantitativa discreta; (iii) qualitativa nominal.   
RESPOSTA: A   
Variáveis qualitativas têm realizações do tipo atributo; quando não há ordenação, são nominais.   
...
Um conjunto de dados (ordenado) é: 2, 3, 5, 7, 8, 10, 11, 12, 15\. Se acrescentarmos um valor discrepante 67, qual medida tende a ser menos afetada por esse acréscimo?   
A) Média aritmética   
B) Mediana   
C) Amplitude (máx-mín)   
D) Máximo   
E) Soma dos valores   
RESPOSTA: B  
A mediana é resistente (robusta) a valores discrepantes: ao inserir 67, a média muda bastante, mas a mediana permanece próxima à mediana original. 

QUESTÃO 18  

Dois conjuntos de dados A e B têm a mesma média amostral x̄=50. O desvio padrão amostral de A é S=5 e o de B é S=10. Qual alternativa descreve corretamente os coeficientes de variação?
...
Se x(1) ≤ x(2) ≤ … ≤ x(n) denota a amostra ordenada, qual alternativa descreve corretamente x(1) e x(n)?  
A) x(1) é a mediana e x(n) é a moda  
B) x(1) é a média e x(n) é o desvio padrão  
C) x(1) é o mínimo e x(n) é o máximo  
D) x(1) é o primeiro quartil e x(n) é o terceiro quartil  
E) x(1) é o máximo e x(n) é o mínimo  
RESPOSTA: C   
Por definição, x(1), x(2), …, x(n) é a amostra em ordem crescente.  
Logo, x(1) é a menor observação (mínimo) e x(n) é a maior observação (máximo).

QUESTÃO 20 

Um conjunto de dados é X \= {2, 2, 4, 6}. Calcule a variância dos dados (variância populacional, isto é, dividindo por n) e assinale a alternativa correta.  
A) 2  
B) 2,75   
C) 3   
D) 11/3  
...
Para a série ordenada 3, 4, 7, 8, 8 e 9, qual é a mediana?  
A) 7  
B) 7,5  
C) 8  
D) 8,5  
E) 9  
RESPOSTA: B  
Como n \= 6 é par, a mediana é a média das duas observações centrais.  
As observações centrais são a 3ª e a 4ª: 7 e 8\.  
Mediana \= (7 \+ 8\) / 2 \= 7,5

QUESTÃO 22 

Considere as observações (em ordem crescente): 3, 4, 7, 8 e 8\. Qual é a média aritmética desses dados?  
A) 6  
B) 7  
C) 7,5  
D) 7,6  
...
Em uma amostra de velocidades do vento, um valor atípico (muito grande) é  
incluído. Qual medida tende a ser MAIS afetada por esse valor atípico?  
A) Mediana  
B) Moda  
C) Média aritmética  
D) Quartil Q1  
E) Desvio absoluto mediano (DAM)  
RESPOSTA: C   
Medidas resistentes mudam pouco com valores extremos (mediana, quartis, DAM).  
...
Considere as variáveis a seguir, observadas em um levantamento com estudantes: (i) cor dos olhos; (ii) número de irmãos; (iii) pressão arterial (mmHg); (iv) nível de satisfação (baixo/médio/alto). Classifique cada uma como qualitativa nominal, qualitativa ordinal, quantitativa discreta ou quantitativa contínua.   
A) (i) nominal; (ii) discreta; (iii) contínua; (iv) ordinal   
B) (i) ordinal; (ii) discreta; (iii) discreta; (iv) nominal   
C) (i) nominal; (ii) contínua; (iii) contínua; (iv) ordinal   
D) (i) nominal; (ii) discreta; (iii) ordinal; (iv) contínua   
E) (i) ordinal; (ii) contínua; (iii) contínua; (iv) nominal   
RESPOSTA: A  
• (i) Cor dos olhos: categorias sem ordenação → qualitativa nominal.   
...
QUESTÃO 25   
Os valores de uma variável X são: 4, 6, 6, 7, 9\. Qual é a média aritmética?   
A) 5,6   
B) 6,4   
C) 6,8   
D) 7,0   
E) 7,6  
RESPOSTA: B  
Soma \= 4+6+6+7+9 \= 32\. Como n \= 5, a média é x-bar \= 32/5 \= 6,4.

QUESTÃO 26   
Uma variável X assume os valores 0, 1 e 2 com frequências 2, 3 e 1, respectivamente (n \= 6). Usando a definição de variância com denominador n, calcule var(X).   
A) 0,28   
B) 0,47   
C) 0,56   
D) 0,67   
E) 1,02  
RESPOSTA: B  
Primeiro, a média: x-bar \= (0\*2 \+ 1\*3 \+ 2\*1)/6 \= 5/6 ≈ 0,8333.   
...
QUESTÃO 27   
Considere os dados ordenados: 2, 3, 5, 7, 8, 9, 10, 11, 12, 15, 67\. De acordo com a definição usual de quartis apresentada no capítulo de quantis empíricos, quais são q1 (1º quartil) e q3 (3º quartil)?   
A) q1 \= 3 e q3 \= 12   
B) q1 \= 5 e q3 \= 12   
C) q1 \= 5 e q3 \= 15   
D) q1 \= 7 e q3 \= 12   
E) q1 \= 7 e q3 \= 15   
RESPOSTA: B   
Os dados separam-se em quatro partes pelos quartis q1, q2 (mediana) e q3. Para esse conjunto, o texto indica q1 \= 5 e q3 \= 12 (com q2 \= 9).

QUESTÃO 28  
A variável “nível de escolaridade” é classificada como:
...
RESPOSTA: D  
“Nível de escolaridade” é uma variável qualitativa ordinal, pois é uma categoria que possui uma ordem/hierarquia.

QUESTÃO 29  
A medida que indica o quanto os dados estão dispersos em torno da média é:
...
QUESTÃO 30  
Qual desses exemplos é considerado uma variável quantitativa discreta
...
RESPOSTA: B  
“Número de filhos” é uma variável quantitativa discreta, pois são valores numéricos inteiros.

QUESTÃO 31  
Num experimento, 15 coelhos foram alimentados com uma nova ração e tiveram seus pesos avaliados ao fim do mês. Os dados referentes ao ganho de peso dos coelhos (em quilogramas) foram: 1,5; 1,6; 2,3; 1,7; 1,5; 2,0; 1,5; 1,8; 2,1; 2,1; 1,9; 1,8; 1,7; 2,5 e 2,2  
...
RESPOSTA: D  
1,5 \+ 1,6 \+ 2,3 \+ 1,7 \+ 1,5 \+ 2,0 \+ 1,5 \+ 1,8 \+ 2,1 \+ 2,1 \+ 1,9 \+ 1,8 \+ 1,7 \+ 2,5 \+ 2,2 \= 28,2  
28,2 / 15 \=1,88

QUESTÃO 32:   
Os dados abaixo referem-se à dureza de 12 peças de alumínio:   
...
Desvio padrão: 141,437 \= 11,893

QUESTÃO 33:   
Vamos considerar os dados abaixo, extraídos de Graedel e Kleiner (1985) e que representam as velocidades do vento no aeroporto de Philadelphia (EUA) para os primeiros 15 dias de dezembro de 1974\.  
22,2; 61,1; 13,0; 27,8; 22,2; 27,4; 27,4; 27,4; 20,4; 20,4; 20,4; 11,1; 13,0; 27,4; 14,8;  
Qual é a média e a mediana da velocidade do vento?
...
RESPOSTA: E  
Média: 22,2+61,1+13,0+27,8+22,2+27,4+27,4+27,4+20,4+20,4+20,4+11,1+13,0+27,4+14,8 \= 356  
356/15 \= 23,733  
...
QUESTÃO 34  
Uma companhia de seguros analisou a frequência com que 2.000 segurados (1.000 homens e 1.000 mulheres) usaram o hospital. Os resultados foram:![][image10]  
...
RESPOSTA: C  
Existem 100 homens que usaram o hospital e 2000 pessoas totais  
100/2000 \= 0,05
...
RESPOSTA: B  
A frequência relativa equivale a proporção de cada categoria dentro de uma tabela de contingência
...
QUESTÃO 38  
Um grupo de pedagogos estuda a influência da troca de escolas no  
...
RESPOSTA: A  
Quantidade de alunos que cursam mais de uma escola (2 ou mais):  
57 \+ 21 \+ 15 \+ 54 \= 147  
...
QUESTÃO 39  
Alunos da Escola de Educação Física foram submetidos a um teste de  
...
RESPOSTA: A  
Variável quantitativa contínua porque a distância é uma grandeza que pode assumir qualquer valor real 

QUESTÃO 40  
O tempo de utilização de caixas eletrônicos depende de cada usuário e das  
...
QUESTÃO 41  
Foram feitas medidas em operários da construção civil a respeito da taxa de  
...
QUESTÃO 42  
Uma pesquisa coletou os dados de idade de 30 pacientes em uma clínica. Calcule: média, moda e mediana  
...
RESPOSTA: C  
No conjunto A, todos os valores são iguais, logo, não há variabilidade.   
No conjunto B, há valores de 5 a 15, então há variabilidade  
Portanto, o conjunto B apresenta maior dispersão 

QUESTÃO 44  
Em uma empresa, a maioria dos funcionários ganha entre R$ 2.000 e R$ 3.000, mas alguns diretores ganham acima de R$ 20.000.  
...
RESPOSTA: C  
A maioria ganha valores menores, mas há poucos salários muito altos, “puxando” a média para cima. Isso gera uma cauda à direita, chamada de assimetria positiva.

QUESTÃO 45  
Em uma pesquisa com 100 pessoas, podemos afirmar que:
...
(EPCAr 2012\) Suponha que a distribuição das idades dos cadetes do 1º ano da Academia da Força Aérea no ano de 2011 esteja representada pelo gráfico seguinte.  
![][image17]  
...
Podemos transformar o gráfico na seguinte tabela:   
![][image18]  
...
Para saber quantos divisores de 3 e 5 têm entre 1 a 200, primeiro temos que achar o divido comum:
...
P(A) \= probabilidade de chover no dia \* probabilidade de se atrasar quando chove \+ probabilidade de não chover no dia \* probabilidade de não se atrasar quando chove.
...
A tabela nos traz todas as informações importantes, que são o total de pessoas vacinadas (nosso n(U)) e o espaço amostral de casos favoráveis (aqui, nos interessamos pelo número de pessoas vacinadas com doenças crônicas, ou seja, 22). Assim:
...
Para que a aula aconteça no domingo, é preciso que chova no sábado e não chova no domingo. Esse “e” nos mostra que é preciso encontrar o produto entre essas probabilidades. A fórmula muda um pouco:
...
Um dado honesto é lançado uma única vez. Consideremos as variáveis X \= 1, se o número observado é maior ou igual a 3, X \= 0 caso contrário. Seja Y \= 1 se o número observado é par, e Y \= 0 caso contrário. Calcule as distribuições marginais de X e Y. 

A) Distribuições: P(X=0) \= 1/3, P(X=1) \= 2/3, P(X=0) \= 1/2, P(X=1) \= 1/2. 

B) Distribuições: P(X=0) \= 1/3, P(X=1) \= 2/3, P(X=0) \= 1/2, P(X=1) \= 1/3.

C) Distribuições: P(X=0) \= 1/2, P(X=1) \= 1/2, P(X=0) \= 1/2, P(X=1) \= 1/2. 

D) Distribuições: P(X=0) \= 1/3, P(X=1) \= 1/2, P(X=0) \= 1/2, P(X=1) \= 1/2. 

E) Distribuições: P(X=0) \= 1/2, P(X=1) \= 1/2, P(X=0) \= 2/3, P(X=1) \= 1/3. 

RESPOSTA: A 

Distribuições marginais de X e Y:
...
Um dado honesto é lançado uma única vez. Consideremos as variáveis X \= 1, se o número observado é maior ou igual a 3, X \= 0 caso contrário. Seja Y \= 1 se o número observado é par, e Y \= 0 caso contrário. Calcule P(X+Y=1). 
...
Em um pacote com cinco transistores, dois deles são defeituosos. Os transistores são escolhidos ao acaso devem ser testados, um de cada vez, até que aqueles defeituosos sejam identificados. Qual a probabilidade de haver pelo menos um transistor sem defeito entre os dois defeituosos encontrados?
...
Probabilidade de se observar um transistor sem defeito entre os dois defeituosos 
...
QUESTÃO 20 (NOVA) ARRUMAR

Em um pacote com cinco transistores, dois deles são defeituosos. Os transistores são escolhidos ao acaso devem ser testados, um de cada vez, até que aqueles defeituosos sejam identificados. Qual a probabilidade de o primeiro testado ser defeituoso dado que se testou todos?
...
Probabilidade de testar todos dado que o 1º testado foi defeituoso 
...
Em um pacote com cinco transistores, dois deles são defeituosos. Os transistores são escolhidos ao acaso devem ser testados, um de cada vez, até que aqueles defeituosos sejam identificados. Qual é a probabilidade de serem necessários testar todos os cinco transistores para encontrar os dois defeituosos?
...
Probabilidade de testar todos para encontrar os dois defeituosos 
...
QUESTÃO 23 (NOVA) ARRUMAR

A Urna A contém 2 bolas vermelhas e 2 bolas verdes. A Urna B contém 3 bolas vermelhas e 1 bola verde. Uma bola é sorteada ao acaso de cada urna. Se ambas as bolas tiverem a mesma cor, uma terceira bola é sorteada da Urna A. Caso contrário, não há terceira extração. Seja X o número de bolas vermelhas sorteadas ao todo, e Y o número total de bolas sorteadas. Qual a probabilidade de ter tido 3 retiradas, dado que saíram 2 bolas vermelhas no experimento?  
A) 1/2 
...
Probabilidade de ter havido 3 retiradas dado que saíram 2 vermelhas
...
QUESTÃO 24 (NOVA)  
Um dado honesto é lançado uma única vez. Consideremos as variáveis X \= 1, se o número observado é maior ou igual a 3, X \= 0 caso contrário. Seja Y \= 1 se o número observado é par, e Y \= 0 caso contrário. 

A) P(X=0) \= 1/2, P(X=1) \= 1/2

P(Y=0) \= 1/2, P(Y=1) \= 1/2

B) P(X=0) \= 1/3, P(X=1) \= 2/3

P(Y=0) \= 1/2, P(Y=1) \= 1/2

C) P(X=0) \= 2/3, P(X=1) \= 1/3

P(Y=0) \= 1/2, P(Y=1) \= 1/2

D) P(X=0) \= 2/3, P(X=1) \= 1/3

P(Y=0) \= 2/3, P(Y=1) \= 1/3

E) P(X=0) \= 1/3, P(X=1) \= 2/3
...
Um dado honesto é lançado uma única vez. Consideremos as variáveis X \= 1, se o número observado é maior ou igual a 3, X \= 0 caso contrário. Seja Y \= 1 se o número observado é par, e Y \= 0 caso contrário. A probabilidade de P(X+Y=1) é igual a: 
...
Uma moeda honesta é lançada 4 vezes. Qual é o número de sequências possíveis?   
A) 16
...
Como a moeda é lançada 4 vezes, cada lançamento tem dois resultados possíveis: K (cara) ou C (coroa).

Logo, o total de sequências possíveis é 2^4=16 

QUESTÃO 27 (NOVA) ARRUMAR

A tabela abaixo apresenta a distribuição conjunta das variáveis aleatórias X e Y: 
...
Em uma urna existem bolas enumeradas de 1 a 15\. Qualquer uma delas possui a mesma chance de ser retirada. Determine a probabilidade de se retirar uma bola com número primo. 
...
Em uma urna existem bolas enumeradas de 1 a 15\. Qualquer uma delas possui a mesma chance de ser retirada. Determine a probabilidade de se retirar uma bola com número par ou primo. 
...
Em uma urna existem bolas enumeradas de 1 a 15\. Qualquer uma delas possui a mesma chance de ser retirada. Determine a probabilidade de se retirar uma bola com número par e primo.  
A) 1/3   
B) 1/5   
C) 2/15   
D) 1/15   
E) 1/20   
RESPOSTA: D  
Dentro do intervalo dado, temos um único número que satisfaz a condição de ser par e primo ao mesmo tempo, que é o número 2\. Portanto, temos a seguinte probabilidade:   
P \= 1/15 

QUESTÃO 32 (NOVA) ARRUMAR

Um teste de múltipla escolha é composto de 12 questões, com 5 alternativas de resposta, sendo que somente uma é correta. Calcule a probabilidade, em porcentagem aproximada, de uma pessoa, marcando aleatoriamente as 12 questões, acertar metade das respostas.   
A) 1,5625%   
B) 0,8%   
C) 1,55%   
D) 0,1%   
...
Uma moeda é lançada 10 vezes. Determine a probabilidade aproximada (em porcentagem) de sair “coroa” 7 vezes.   
A) 4,40%   
B) 11,72%   
C) 12,50%   
D) 25%  
...
Se P(A)=0,30, P(B)=0,40 e A e B são independentes, então P(A∩B) é:
...
E) P(A∪B)=P(A)P(B)  
RESPOSTA: C  
A definição adotada no capítulo de probabilidades é:   
A e B são independentes ⇔ P(A∩B)=P(A) . P(B).

QUESTÃO 36 

Em termos de A e B com P(B)\>0, o Teorema de Bayes (versão simples) fornece P(A|B) como:  
A) P(A|B)=P(A)P(B)  
B) P(A|B)=P(A∩B)/P(A)  
C) P(A|B)=P(A∩B)/P(B)=P(A)·P(B|A)/P(B)  
D) P(A|B)=P(B|A)  
E) P(A|B)=1-P(B|A)  
RESPOSTA: C  
P(A|B)=P(A∩B)/P(B).   
...
Num experimento binomial com parâmetros n e p, a probabilidade de X=k sucessos é:
...
D) P(X=k)= (1/√(2π)) e^{-k^2/2}

E) P(X=k)= p(1-p)^{k-1}

RESPOSTA: B

Pelo modelo binomial b(n,p), a função de probabilidade é 

b(k;n,p)=C(n,k)p^k q^{n-k}, com q=1-p, para k=0,1,...,n.

QUESTÃO 38 

Um telefone recebe, em média, 5 chamadas por minuto. Supondo um modelo de Poisson, qual é a probabilidade de não receber chamadas em 1 minuto?  
A) e^{-5}  
B) 1-e^{-5}  
C) 5e^{-5}  
D) e^{-1/5}  
...
Uma moeda é lançada 5 vezes (p=0,5 de cara). Seja X o número de caras. Qual é P(X=3)?  
A) 5/32  
B) 10/32  
C) 1/2  
D) 3/8  
...
Uma variável Z segue a distribuição normal padrão N(0,1), e uma variável Y segue a distribuição qui-quadrado com ν graus de liberdade, sendo Z e Y independentes. A variável t é definida como t \= Z/√(Y/ν). A distribuição da variável t é:   
A) Normal padrão  
B) Qui-quadrado com ν g.l.  
C) t de Student com ν g.l.  
D) F com (1,ν) g.l.  
E) Uniforme(0,1)  
RESPOSTA: C   
A definição da distribuição t de Student com ν graus de liberdade é exatamente:   
t \= Z/√(Y/ν)

QUESTÃO 41 

Se X \~ N(μ, σ²), então E(X) e Var(X) são, respectivamente:
...
No modelo normal, os momentos básicos são E(X)=μ e Var(X)=σ² 

QUESTÃO 42 

Se X \~ N(1000, 20²), qual é P(X \< 980)? (Use a padronização Z=(X-μ)/σ e Φ(-1)=0,1587.)  
A) 0,8413  
B) 0,5000  
C) 0,1587  
D) 0,0228  
E) 0,9772  
RESPOSTA: C   
Z=(980-1000)/20 \= \-20/20 \= \-1.   
Logo P(X\<980) \= P(Z\<-1) \= Φ(-1) \= 0,1587.

QUESTÃO 43 

Um lote tem 20 peças, das quais 5 são defeituosas. Escolhem-se 4 peças ao acaso, sem considerar a ordem. Qual é a probabilidade de obter exatamente 2 defeituosas?   
A) C(5,2) · C(15,2) / C(20,4)   
B) C(5,2) · C(15,2) / C(20,2)   
C) C(5,4) / C(20,4)   
D) C(15,2) / C(20,4)   
E) C(5,2) / C(20,4)  
RESPOSTA: A   
O espaço amostral tem C(20,4) amostras possíveis (sem ordem).  
...
Suponha que P(A∩B)=0,20 e P(B)=0,50 (com P(B)\>0). Qual é P(A|B)?  
A) 0,10  
B) 0,20  
C) 0,30  
D) 0,40  
...
E) P(A) \= 1 − P(B)  
RESPOSTA: C   
A e B são independentes quando a ocorrência de um não altera a probabilidade do outro.   
Uma condição equivalente é P(A∩B) \= P(A) . P(B) 

QUESTÃO 46 

Se P(B)\>0, a probabilidade condicional de A dado B é definida por:  
A) P(A|B)=P(A)P(B)  
B) P(A|B)=P(A∩B)/P(B)  
C) P(A|B)=P(B∩A)/P(A)  
D) P(A|B)=P(A)+P(B)  
E) P(A|B)=1−P(A∩B)  
RESPOSTA: B   
Pela definição, quando P(B)\>0:   
P(A|B) \= P(A∩B) / P(B)

QUESTÃO 47 

Em uma universidade, há 200 alunos distribuídos entre cursos. No curso de Estatística, há 30 alunos, dos quais 20 são mulheres. Se um aluno é escolhido ao acaso e sabe-se que ele está matriculado em Estatística, qual é P(mulher | Estatística)?   
A) 1/10   
B) 1/3   
C) 2/3   
D) 3/5   
E) 20/200   
RESPOSTA: C  
P(mulher | Estatística) \= (nº de mulheres em Estatística)/(total em Estatística) \= 20/30 \= 2/3. 

QUESTÃO 48   
Um teste para uma doença retorna positivo (evento B). A prevalência da doença é P(A)=0,01. A sensibilidade é P(B|A)=0,90 e a taxa de falso positivo é P(B|A^c)=0,05. Qual é a probabilidade de um indivíduo estar doente dado que o teste foi positivo, P(A|B)?   
A) 0,015   
B) 0,154   
C) 0,321   
D) 0,500   
...
QUESTÃO 49   
Se P(A) \= 0,30, qual é P(A^c) (o complementar de A)?   
A) 0,30   
B) 0,70   
C) 1,30   
D) 0,15   
...
QUESTÃO 50   
Se X \~ b(n=10, p=0,2), calcule P(X \= 3).   
A) 0,0881   
B) 0,1209   
C) 0,2013   
D) 0,2684   
E) 0,3222  
RESPOSTA: C  
P(X=3) \= C(10,3) p^3 (1-p)^(10-3) \= 120\*(0,2)^3\*(0,8)^7.   
(0,2)^3 \= 0,008 e (0,8)^7 ≈ 0,2097152.   
Logo, P ≈ 120\*0,008\*0,2097152 ≈ 0,2013266. 

QUESTÃO 51   
Uma v.a. discreta X tem P(X=0) \= 0,2, P(X=1) \= 0,5 e P(X=2) \= 0,3. Calcule E(X) e Var(X).   
A) E(X)=1,1 e Var(X)=0,49  
B) E(X)=1,0 e Var(X)=0,70  
C) E(X)=1,3 e Var(X)=0,49  
D) E(X)=1,1 e Var(X)=0,70  
E) E(X)=1,0 e Var(X)=0,49  
RESPOSTA: A  
E(X) \= Σ x p(x) \= 0\*0,2 \+ 1\*0,5 \+ 2\*0,3 \= 0,5 \+ 0,6 \= 1,1.  
E(X^2) \= Σ x^2 p(x) \= 0 \+ 1\*0,5 \+ 4\*0,3 \= 0,5 \+ 1,2 \= 1,7.  
Var(X) \= E(X^2) \- \[E(X)\]^2 \= 1,7 \- (1,1)^2 \= 1,7 \- 1,21 \= 0,49.

QUESTÃO 52   
Em 100 intervalos de tempo, observou-se o número de eventos N com a seguinte frequência: n0=20, n1=30, n2=25, n3=25 (e nenhum intervalo com 4 ou mais eventos). Adote o modelo de Poisson e estime lambda pela média amostral. Em seguida, calcule P(N=0) pelo modelo ajustado.  
A) lambda \=1,25 e P(N=0)=0,286  
B) lambda \=1,55 e P(N=0)=0,212  
C) lambda \=1,55 e P(N=0)=0,788  
D) lambda \=1,75 e P(N=0)=0,174  
E) lambda \=2,05 e P(N=0)=0,129  
RESPOSTA: B  
Estimativa por média:   
lambda \= (0\*20 \+ 1\*30 \+ 2\*25 \+ 3\*25)/100 \= (30+50+75)/100 \= 155/100 \= 1,55.   
No modelo de Poisson, P(N=0)=e^{-lambda } \= e^{-1,55} ≈ 0,212.

QUESTÃO 53   
Se X \~ N(  \=100,  \=10), qual é P(X \<= 115)? (Use a transformação        Z=(X-)/ e (1,5)=0,9332.)   
A) 0,0668  
B) 0,5000  
C) 0,9332  
D) 0,9750  
...
QUESTÃO 54  
Considere dois eventos A e B mutuamente exclusivos, sendo a  P(A)=0,5, a P(B)=x e a P(AUB)= 0,8.   
...
RESPOSTA: C  
Se os eventos A e B são mutuamente exclusivos  
P(AUB) \= P(A) \+ P(B)  
0,8=0,5+x  
0,8-0,5=x  
x \= 0,3
...
QUESTÃO 56  
O complemento de um evento A é:
...
QUESTÃO 57  
Considere A o evento: sair um número par. Calcule P(A) ao rolar um dado justo
...
QUESTÃO 58  
Seja X uma variável aleatória discreta que segue o modelo Uniforme com os valores no conjunto {1, 2, 3,…, 10}. Calcule P(X\<= 9 | X\>=6) 
...
RESPOSTA: D  
P(X\<=9 | X\>=6) \= P(X\<=9 | X\>=6) / P(X\>=6) \= 4/5 \= 0.8  
 

QUESTÃO 59  
Seja X uma variável que segue o modelo Binomial com n=15 e p=0,4. Calcule P(X\>=4)
...
QUESTÃO 62  
Uma moeda é lançada duas vezes e observam-se as faces obtidas. Descreva o espaço amostral considerando K para coroa e C para cara
...
RESPOSTA: D  
As combinações possíveis em dois lançamentos de uma moeda são:  
CARA, CARA  
CARA, COROA  
COROA, CARA  
COROA, COROA
...
QUESTÃO 63  
Dois dados são lançados simultaneamente e estamos interessados na soma das faces observadas. Considerando A o evento “Saírem apenas somas pares”, calcule P(A)
...
RESPOSTA: B  
Os resultados para somas pares são:  
...
RESPOSTA: E  
Como L1 possui capacidade de produzir quatro vezes mais baterias do que a linha L2 e sabendo que a soma das probabilidades deve ser 1,  
P(L1) \= 4x  
P(L2) \= x  
x \+ 4x \= 1  
5x \= 1  
...
QUESTÃO 65  
Ao lançar um dado honesto uma vez, qual é o espaço amostral? 
...
RESPOSTA: B  
O espaço amostral é o conjunto de todos os resultados possíveis. Num dado, os resultados possíveis são: {1,2,3,4,5,6}

QUESTÃO 66  
Uma urna tem 3 bolas vermelhas (V) e 2 bolas azuis (A). Ao retirar uma bola da urna e observar sua cor, qual o espaço amostral?
...
RESPOSTA: A  
Ao observar apenas a cor, os resultados possíveis são: bola vermelha (V) ou bola azul (A)

QUESTÃO 67  
Ao lançar dois dados honestos, quantos resultados possíveis existem no espaço amostral?
...
RESPOSTA: E  
Cada dado possui 6 possibilidades, como são dois dados: 6 \* 6 \= 36 resultados possíveis

QUESTÃO 68  
Pelo axioma, qual afirmação é sempre verdadeira para qualquer evento A?
...
RESPOSTA: C  
Para qualquer evento A, sua probabilidade sempre fica entre 0 e 1\.

QUESTÃO 69  
Se P(A)=0,62, qual é a probabilidade do complemento de A?
...
QUESTÃO 70  
Se P(A)=0,5, P(B)=0,4 e P(A∩B)=0,2, então qual é a P(A∪B)? 
...
QUESTÃO 71  
Considere que P(A)=0,5 e P(B|A)=0,8. Calcule a P(A∩B):
...
RESPOSTA: A  
Aplicando a fórmula: P(A∩B)=P(A)·P(B|A)  
P(A∩B)= 0,5 \* 0,8 \= 0,4 

QUESTÃO 72  
Uma doença atinge apenas 2% da população. Sabe-se que o teste dessa doença dá positivo em 95% dos doentes e falso positivo em 5% dos não doentes. Considerando que uma pessoa testou positivo, qual a probabilidade dela estar doente? 
...
QUESTÃO 73  
Considere uma urna contendo três bolas pretas e cinco bolas vermelhas. Retire duas bolas da urna, sem reposição e calcule a probabilidade de sair uma bola preta na primeira e segunda extrações
...
RESPOSTA: D  
Temos 3 bolas pretas (P) e 5 bolas vermelhas (V), no total, 8 bolas  
...
# QUESTÕES DE INFERÊNCIA ESTATÍSTICA
...
A) O teste de hipótese deve ser bilateral, pois o pesquisador quer verificar se o consumo é diferente de R$ 2.000.  
B) O valor da estatística de teste será positivo, pois a média amostral é maior que a média hipotética.  
C) A hipótese nula será rejeitada se o valor-p for maior que 0,05.  
D) Adotando como hipótese de que o desvio padrão populacional seja conhecido e é igual a R$ 300 (igual ao amostral), então o teste deve usar a distribuição t de Student.   
E) O intervalo de confiança de 95% para a média populacional será maior que R$ 2.000.

QUESTÃO 2 

Uma população tem μ=50 e σ=10. Retira-se uma amostra aleatória de tamanho n=36. Usando o TLC, aproxime P(X̄ \> 52). (Use Φ(1,2)=0,8840.)  
A) 0,1160  
B) 0,8840  
C) 0,1587  
D) 0,5000  
...
Deseja-se escolher n tal que P(|X̄-μ| ≤ ε) \= γ, assumindo σ² conhecida. Se σ=4, ε=0,5 e γ=0,95 (use z\_γ \= 1,96), qual n o livro obtém pela fórmula   
n \= σ² . z\_γ² / ε² (arredonde para cima)?  
A) 62  
B) 123  
C) 246  
D) 16  
...
Pelo Teorema Limite Central, se a população tem média μ e variância σ² finita, então para n grande a média amostral X̄ é aproximadamente:  
A) N(0,1)  
B) N(μ, σ²)  
C) N(μ, σ²/n)  
D) b(n, μ)  
E) Poisson(σ²/n)  
RESPOSTA: C   
O TLC afirma que, para n grande, a distribuição amostral de X̄ aproxima-se de N(μ, σ²/n).

QUESTÃO 5 

Em uma pesquisa com n=300 pessoas, 180 preferem um produto. Use p̂=180/300=0,6 e  
γ=0,90 (use z≈1,645). Qual intervalo aproxima p usando p̂ ± z·sqrt(p̂(1-p̂)/n)?  
A) \]0,55; 0,65\[  
B) \]0,56; 0,64\[  
C) \]0,58; 0,62\[  
D) \]0,50; 0,70\[  
...
QUESTÃO 7   
Se (X1,…,Xn) é uma AAS(Amostra Aleatória Simples) de uma população com média μ e variância σ², qual é Var(X̄)?  
A) σ²  
B) σ²/n  
C) σ/√n  
D) σ²/(n−1)  
E) nσ²  
RESPOSTA: B   
Para uma AAS, Var(X̄)=σ²/n

QUESTÃO 8 

Deseja-se que P(|X̄−μ| ≤ ε)=γ, com σ conhecida. A expressão que relaciona n, σ, ε e zγ é:  
A) n \= (σ zγ)/ε  
B) n \= (σ² zγ)/ε²  
C) n \= (σ² zγ²)/ε²  
D) n \= (ε² zγ²)/σ²  
E) n \= (σ zγ²)/ε²  
RESPOSTA: C   
Padronize: Z \= (X̄−μ)√n/σ \~ N(0,1)  
Imponha P(|Z|≤zγ)=γ ⇒ zγ \= ε√n/σ  
Então √n \= (σ zγ)/ε ⇒ n \= (σ² zγ²)/ε²

QUESTÃO 9 

Em n \= 400 provas, obtém-se k \= 80 sucessos. Para γ \= 0,90 e z \= 1,645, qual é o IC aproximado para p usando √(p̂ q̂ /n)?  
A) \]0,150; 0,250\[  
B) \]0,167; 0,233\[  
C) \]0,180; 0,220\[  
D) \]0,159; 0,241\[  
...
Uma amostra de tamanho n \= 25 de uma população normal tem média X̄ \= 485 e desvio padrão populacional σ \= 10 (conhecido). Para γ \= 0,95, qual é o IC para μ? (Use z \= 1,96.)  
A) \]481; 489\[  
B) \]483; 487\[  
C) \]480; 490\[  
D) \]482; 488\[  
E) \]479; 491\[   
RESPOSTA: A   
Erro padrão: σ/√n \= 10 / 5 \= 2  
Margem: 1,96 · 2 \= 3,92  
IC: \]485−3,92; 485+3,92\[ \= \]481,08; 488,92\[ ≈ \]481; 489\[ 

QUESTÃO 11 

Em um teste de hipóteses, o erro de tipo I corresponde a:  
A) Aceitar H0 quando H0 é falsa  
B) Rejeitar H0 quando H0 é verdadeira  
C) Aceitar H1 quando H1 é falsa  
D) Rejeitar H1 quando H1 é verdadeira  
E) Sempre rejeitar H0  
RESPOSTA: B  
Erro tipo I (α): rejeitar H0 mesmo quando H0 é verdadeira.  
Erro tipo II (β): não rejeitar H0 quando H0 é falsa.

QUESTÃO 12 

No teste H0: p \= 0,60 vs H1: p\<0,60, com n \= 200 e α \= 0,05, a região crítica pode ser expressa como p̂ ≤ p̂c. Qual é p̂c aproximado (use zα \= −1,645)?
...
Sob H0, p̂ ≈ N(p0, p0(1−p0) / n), com p0 \= 0,60
...
QUESTÃO 14  
Uma variável aleatória X tem distribuição normal, com média 100 e desvio padrão 10\. Qual a P(90 \< X \< 110)?
...
QUESTÃO 15  
Uma população tem distribuição normal com média 100 e desvio padrão 10\. Uma amostra de tamanho (n) 16 é retirada dessa população.  
...
QUESTÃO 16  
O peso dos pacotes produzidos por uma máquina segue distribuição normal com desvio padrão 10 g.  
...
QUESTÃO 19  
Uma companhia de cigarros anuncia que o índice médio de nicotina dos cigarros que fabrica apresenta-se abaixo de 23 mg por cigarro.  
...
QUESTÃO 21  
Em um teste de hipóteses estatístico, o objetivo principal é:
...
QUESTÃO 22  
O teste Qui-quadrado de independência é utilizado para:
...
QUESTÃO 23  
Uma pesquisadora quer saber se existe relação entre gênero (masculino/feminino) e preferência por modalidade de aula (presencial/online).  
...
RESPOSTA: C  
QUESTÃO 24  
Considerando x a idade e P o peso, analise o modelo de regressão linear simples e responda: P=2+3x  
...
RESPOSTA: B   
Quando a idade(x) for 0,  
P= 2 \+ 3\*0 \= 2

QUESTÃO 25  
O coeficiente de correlação de Pearson entre anos de estudo e salário em um grupo de pessoas foi r=0,85  
Esse valor indica:
...
RESPOSTA: C   
Como o valor da correlação de Pearson foi 0,85 (próximo de 1), existe correlação forte e positiva.

QUESTÃO 26  
Em um estudo sobre horas de exercício físico por semana (x)  e nível de colesterol (y) , obteve-se: y \= 210 \- 3x e a correlação de Pearson: r=0,70  
...
QUESTÃO 27  
Em um estudo que relaciona horas de estudo e nota, a variável explicativa (X) é:
...
QUESTÃO 28  
Em um estudo entre anos de estudo e salário, obteve-se R^2=0,64. Isso significa que:
...
QUESTÃO 29  
Considere o modelo: Salário \= 1000 \+ 200x (anos de estudo)   
...
QUESTÃO 30  
Uma pesquisa deseja conhecer a renda média mensal de todos os professores de uma cidade. Para isso, coleta dados de 120 professores escolhidos aleatoriamente. Assinale a alternativa correta:
...
QUESTÃO 32  
Uma fábrica deseja conhecer o peso médio de todos os pacotes produzidos diariamente. Como seria inviável pesar todos os pacotes, foram escolhidos 50 pacotes aleatoriamente e calculada a média de seus pesos.  
...
QUESTÃO 33  
Uma população tem média μ \= 100 e desvio padrão σ \= 20\. Uma amostra de tamanho n \= 25 é retirada. Qual o desvio padrão da média amostral?
...
QUESTÃO 34  
Em uma população, a proporção de defeituosos é p \= 0,30. Uma amostra de n \= 100 peças é retirada. Qual o desvio padrão da proporção amostral?
...
RESPOSTA: B  
Aplicando a fórmula do desvio padrão da proporção amostral:   
...
QUESTÃO 35  
Uma população é normal com μ \= 50 e σ \= 8\. Retira-se uma amostra de tamanho n \= 16\. Qual a probabilidade de a média amostral ser maior que 52? 
...
QUESTÃO 69 \- 2   
Uma população tem variância ^2 \= 144 ( \= 12). Para uma amostra aleatória simples de tamanho n=36, qual é o desvio padrão de X (a média amostral)?   
A) 12   
B) 6  
C) 2   
D) 4   
E) 144  
RESPOSTA: C  
Pelo teorema: Var(X) \= ^2/n \= 144/36 \= 4\.   
Logo, dp(X) \= 4 \= 2\.

QUESTÃO 70 \- 2   
Uma população tem média  \= 50 e desvio padrão  \=8. Para uma AAS de tamanho n \= 64, aproxime P(48 \< X \< 52\) assumindo que X é aproximadamente normal.   
A) 0,6826   
B) 0,8000   
C) 0,9000   
D) 0,9545   
E) 0,9973   
RESPOSTA: D  
Temos E(X)=  \= 50 e dp(X)=/n \= 8/64 \= 8/8 \= 1\.   
...
RESPOSTA: C  
A probabilidade de um evento impossível é zero. Isso significa que não há nenhuma chance de ocorrência, representando um conjunto vazio dentro do espaço amostral. 
...
QUESTÃO 83 \- 3   
Uma amostra aleatória simples de tamanho n \= 25 de uma população normal com  \=10 forneceu média x-bar \= 120\. Construa um IC de 95% para  usando z(0,95)=1,96.   
A) \[118,04; 121,96\]   
B) \[116,08; 123,92\]   
C) \[115,00; 125,00\]   
D) \[117,00; 123,00\]   
E) \[116,40; 123,60\]  
RESPOSTA: B  
IC(  ;95%) \= \[x-bar \- z\*  /n, x-bar \+ z\*  /n\].   
Erro padrão \=  /n \= 10/5 \= 2\.   
Margem \= 1,96\*2 \= 3,92. IC \= \[120-3,92, 120+3,92\] \= \[116,08; 123,92\]. 

QUESTÃO 84 \- 3  
Queremos um IC de 95% para a média  de uma população com desvio padrão conhecido sigma=10, com margem de erro (metade da amplitude) no máximo 2\. Qual o menor n que garante isso? Use z=1,96.  
A) n=25   
B) n=49   
C) n=64   
D) n=97   
E) n=100  
RESPOSTA: D  
A margem é z\*/n. Exigimos z\*/n \<= 2\.   
Então n \>= z\*/2 \= 1,96\*10/2 \= 9,8.   
Logo n \>= 9,8^2 \= 96,04.   
O menor inteiro é n \= 97\.

QUESTÃO 85 \- 3  
Considere o teste unilateral H0: mu \= 50 contra H1: mu \> 50, com sigma=12 conhecida. Uma AAS de tamanho n=36 forneceu x-bar=54. Ao nível alpha=5%, qual decisão é correta? (Use z0,95=1,645.)   
A) Não rejeitar H0, pois z=1,33 \< 1,645   
B) Rejeitar H0, pois z=2,00 \> 1,645   
C) Não rejeitar H0, pois z=0,67 \< 1,645   
D) Rejeitar H0, pois z=1,50 \> 1,645   
E) Não é possível decidir sem conhecer sigma  
RESPOSTA: B  
Estatística do teste: z \= (x-bar \- 0)/(/n) \= (54-50)/(12/6) \= 4/2 \= 2,00.  
Como o teste é unilateral à direita e z \= 2,00 \> z0,95 \= 1,645, rejeitamos H0 ao nível de 5%.

QUESTÃO 86 \- 3   
Em um teste de hipóteses, obteve-se valor-p \= 0,03. Qual afirmação é correta?   
A) Rejeita-se H0 para qualquer nível de significância alpha.   
B) Não se rejeita H0 para alpha=0,05.  
C)  Rejeita-se H0 para alpha=0,05, mas não necessariamente para alpha=0,01.  
D) O valor-p é a probabilidade de H0 ser verdadeira.  
E) O valor-p independe dos dados amostrais.  
RESPOSTA: C  
O valor-p é o menor nível de significância (alpha) para o qual H0 seria rejeitada com os dados observados.   
Assim, se alpha=0,05 (\>0,03), rejeitamos H0; se alpha=0,01 (\<0,03), não rejeitamos H0. 

QUESTÃO 87 \- 3   
Em um teste de hipóteses, o erro do tipo I é:   
A) Aceitar H0 quando H0 é falsa.   
B) Rejeitar H0 quando H0 é verdadeira.  
C) Rejeitar H1 quando H1 é verdadeira.  
D) Aceitar H1 quando H1 é falsa.  
E) Tomar qualquer decisão quando alpha=0.  
RESPOSTA: B  
Por definição, erro tipo I ocorre quando rejeitamos a hipótese nula H0 sendo ela verdadeira (probabilidade alpha).

QUESTÃO 88 \- 3  
Uma empresa afirma que 50% dos clientes preferem a marca A. Em uma amostra aleatória de n=100 clientes, 60 preferiram A. Teste H0: p \= 0,5 contra H1: p  0,5 ao nível de 5% usando a aproximação normal para p-hat.  
A) Não rejeitar H0, pois z=1,00 \< 1,96  
B) Rejeitar H0, pois z=2,00 \> 1,96  
C) Não rejeitar H0, pois z=2,00 \< 1,96  
D) Rejeitar H0, pois z=1,50 \> 1,96  
E) Não é possível usar normal para n=100  
RESPOSTA: B  
Proporção amostral: p-hat \= 60/100 \= 0,60.   
...
QUESTÃO 89 \- 1   
Considere as variáveis observadas em uma pesquisa: (I) estado civil (solteiro, casado, …); (II) número de filhos; (III) peso (kg); (IV) grau de instrução (fundamental, médio, superior). A classificação correta (qualitativa nominal/ordinal; quantitativa discreta/contínua) é:   
A) I nominal; II discreta; III contínua; IV ordinal.   
B) I ordinal; II contínua; III discreta; IV nominal.   
C) I nominal; II contínua; III contínua; IV nominal.   
D) I ordinal; II discreta; III contínua; IV nominal.   
E) I nominal; II discreta; III discreta; IV ordinal.   
RESPOSTA: A  
I: qualitativa nominal (não há ordenação). II: quantitativa discreta (contagem). III: quantitativa contínua (mensuração). IV: qualitativa ordinal (há ordenação: fundamental \< médio \< superior).

QUESTÃO 90 \- 1   
Em uma turma com n \= 40 alunos, 10 reprovaram. A frequência relativa f e a porcentagem correspondente são:   
A) f \= 10/40 \= 0,25 e 25%.   
B) f \= 10/40 \= 0,40 e 40%.   
C) f \= 40/10 \= 4 e 4%.   
D) f \= 30/40 \= 0,75 e 75%.   
E) f \= 10/40 \= 2,5 e 2,5%.   
RESPOSTA: A  
Por definição, f \= ni /n.   
Logo, f \= 10/40 \= 0,25 e 100·f \= 25%.

QUESTÃO 91 \- 1   
Os valores (em horas) de estudo de 5 alunos foram: 2, 3, 3, 4, 8\. A média amostral x̄ é:   
A) x̄ \= (2+3+3+4+8)/5 \= 4\.   
B) x̄ \= (2+3+3+4+8)/5 \= 5\.   
C) x̄ \= (2+3+3+4+8)/4 \= 5\.   
D) x̄ \= (2+3+3+4+8)/5 \= 3\.   
E) x̄ \= (2·3·3·4·8)^(1/5) \= 4\.  
RESPOSTA: A  
Somando: 2+3+3+4+8 \= 20\. Então x̄ \= 20/5 \= 4\. 

QUESTÃO 92 \- 1   
Para a amostra 1, 2, 3, calcule a variância amostral s² (com denominador n−1).   
A) s² \= 1\.   
B) s² \= 2/3.   
C) s² \= 2\.  
D) s² \= 1/3.   
...
QUESTÃO 93 \- 1   
Considere os dados ordenados: 1, 2, 3, 4, 5, 6, 7, 8\. Tomando Q1 como a mediana da metade inferior e Q3 como a mediana da metade superior, a amplitude interquartílica (AIQ \= Q3 − Q1) é:   
A) AIQ \= 4\.   
B) AIQ \= 3\.   
C) AIQ \= 2\.   
D) AIQ \= 5\.   
E) AIQ \= 1\.  
RESPOSTA: B  
Metade inferior: 1,2,3,4 ⇒ Q1 \= (2+3)/2 \= 2,5.   
Metade superior: 5,6,7,8 ⇒ Q3 \= (6+7)/2 \= 6,5.   
AIQ \= Q3−Q1 \= 6,5−2,5 \= 4,0.

QUESTÃO 94 \- 3  
Considere os pares (x,y): (1,1), (2,2), (3,3). O coeficiente de correlação linear de Pearson r é:   
A) r \= 0\.   
B) r \= −1.  
C) r \= 1\.   
D) r \= 1/2.   
E) r \= −1/2.   
RESPOSTA: C  
Aqui y \= x exatamente, logo há associação linear perfeita positiva. Formalmente, r \= cov(x,y)/(sx sy ) \= 1\.

QUESTÃO 95 \- 2  
Se P(A)=0,40, P(B)=0,35 e P(A∩B)=0,10, então P(A∪B) é:   
A) 0,75   
B) 0,65   
C) 0,50   
D) 0,25   
E) 0,85  
RESPOSTA: B  
P(A∪B) \= P(A)+P(B)−P(A∩B) \= 0,40+0,35−0,10 \= 0,65. 

QUESTÃO 96 \- 2   
Dados P(A)=0,30, P(B)=0,50 e P(A∩B)=0,12. A e B são independentes?   
A) Sim, pois P(A∩B)=P(A)+P(B).   
B) Sim, pois P(A∩B)=P(A)·P(B).   
C) Não, pois P(A∩B)≠P(A)·P(B).   
D) Não, pois P(A|B)=P(B|A).   
E) Sim, pois P(A|B)=P(A)−P(B).   
RESPOSTA: C  
Independência exige P(A∩B)=P(A)·P(B)=0,30·0,50=0,15. Como 0,12≠0,15, não são independentes.

QUESTÃO 97 \- 2   
Um teste para uma doença tem sensibilidade 0,95 e especificidade 0,90. A prevalência é 0,02. Se o teste deu positivo, qual é P(doença | \+)? (aprox.)  
A) ≈ 0,16   
B) ≈ 0,50   
C) ≈ 0,68   
D) ≈ 0,95   
E) ≈ 0,02   
RESPOSTA: A  
Seja D \= ‘doença’ e \+ \= ‘teste positivo’.   
P(+|D)=0,95.   
...
QUESTÃO 98 \- 2   
Uma v.a. discreta X assume valores 0, 1, 2 com probabilidades 0,2; 0,5; 0,3. E(X) é:   
A) E(X)=0·0,2+1·0,5+2·0,3=1,1.   
B) E(X)=0·0,2+1·0,5+2·0,3=0,8.   
C) E(X)=0+1+2=3.   
D) E(X)=0,2+0,5+0,3=1.   
E) E(X)=1·0,2+2·0,5+3·0,3=2,1.  
RESPOSTA: A  
E(X)=Σ x·P(X=x)=0·0,2+1·0,5+2·0,3=0+0,5+0,6=1,1. 

QUESTÃO 99 \- 2  
Chegam em média λ=3 chamadas por minuto (modelo de Poisson). Qual é P(X≥3) em um minuto?   
A) 1−e^(−3)(1+3)   
B) e^(−3)(1+3)  
C) 1−e^(−3)(1+3+9/2)   
D) e^(−3)(9/2)   
...
E) 3/10=0,3.  
RESPOSTA: A  
Para U(a,b), P(c ≤ X ≤ d) \= (d−c)/(b−a). Aqui: (7−3)/10 \= 4/10 \= 0,4. 

QUESTÃO 101 \- 2  
Se X \~ N(μ=50, σ=10), qual é P(X≤60)? Use Φ(1)=0,8413.   
A) 0,1587   
B) 0,5000   
C) 0,8413   
D) 0,9000   
E) 0,9772   
RESPOSTA: C  
Padronizando: Z=(X−μ)/σ.   
Para x=60: z=(60−50)/10=1.   
Logo P(X≤60)=P(Z≤1)=Φ(1)=0,8413. 

QUESTÃO 102 \- 2  
Se T \~ Exp(λ), qual expressão é sempre verdadeira para s,t\>0?   
A) P(T\>s+t | T\>s) \= P(T\>t).   
B) P(T≤s+t | T≤s) \= P(T≤t).   
C) P(T\>s+t) \= P(T\>s)+P(T\>t).   
D) P(T\>s+t) \= P(T\>s)·P(T\>t) para qualquer distribuição contínua.   
E) P(T\>s+t | T\>s) \= P(T\>s+t).   
RESPOSTA: A  
A exponencial tem a propriedade sem memória: P(T\>s+t | T\>s)=P(T\>t). As demais alternativas não valem em geral. 

QUESTÃO 103 \- 2   
Considere a p.m.f. conjunta de (X,Y) dada por: P(X=0,Y=0)=0,2; P(0,1)=0,3; P(1,0)=0,1; P(1,1)=0,4. Calcule cov(X,Y).   
A) cov(X,Y)=0,05   
B) cov(X,Y)=−0,05   
C) cov(X,Y)=0   
D) cov(X,Y)=0,10   
...
QUESTÕES 153 \- 1   
Considere os dados (em unidades): 4, 7, 7, 10, 12\. Calcule a média aritmética x̄.   
A) 7,0   
B) 7,5   
C) 8,0   
D) 8,5   
...
QUESTÃO 154 \- 1   
Seis observações ordenadas são: 2, 3, 5, 8, 9, 11\. Qual é a mediana?   
A) 5   
B) 6,5   
C) 7   
D) 8   
E) 9  
RESPOSTA: B  
• Como n \= 6 é par, a mediana é a média das duas observações centrais (3ª e 4ª).   
• md \= (5 \+ 8)/2 \= 6,5. 

QUESTÕES 155 \- 1   
Uma amostra tem n \= 4 valores: 2, 4, 4, 6\. Calcule a variância amostral S² \= ∑(Xi − x̄)²/(n − 1).   
A) 2/3   
B) 4/3   
C) 2   
D) 8/3   
...
QUESTÃO 156 \- 1  
A variável assume os valores 1, 1, 2, 2, 2, 3, 4\. Qual é a moda?   
A) 1   
B) 1,5   
C) 2   
D) 2,5   
E) 4  
RESPOSTA: C  
• A moda é a realização mais frequente.   
• O valor 2 aparece 3 vezes, mais do que os demais. Logo, moda \= 2\. 

QUESTÃO 157 \- 1  
Em uma série de salários, há um único valor muito alto (outlier). Qual medida tende a ser menos afetada por esse valor e, portanto, pode ser mais representativa da posição central?   
A) Média aritmética   
B) Mediana   
C) Variância   
D) Desvio padrão   
E) Amplitude total   
RESPOSTA: B  
• Um valor extremo altera bastante a soma total, deslocando a média.   
...
QUESTÃO 158 \- 1  
Em uma amostra com n \= 20 observações, verificou-se que N(10) \= 7, isto é, há 7 observações ≤ 10\. Qual é o valor da função de distribuição empírica Fe(10) \= N(10)/n?   
A) 0,07   
B) 0,20   
C) 0,35   
D) 0,50   
E) 0,70   
RESPOSTA: C  
• Pela definição, Fe(10) \= N(10)/n.   
• Fe(10) \= 7/20 \= 0,35. 

QUESTÃO 159 \- 2  
Se P(B) \= 0,5 e P(A ∩ B) \= 0,2, calcule P(A|B).   
A) 0,1   
B) 0,2   
C) 0,3   
D) 0,4   
...
QUESTÃO 160 \- 2  
Dois eventos A e B são independentes e P(A) \= 0,3, P(B) \= 0,4. Qual é P(A ∩ B)?   
A) 0,12   
B) 0,16   
C) 0,30   
D) 0,40   
...
QUESTÃO 161 \- 2  
Uma urna é escolhida ao acaso entre três tipos: C1 com probabilidade 0,4, C2 com probabilidade 0,4 e C3 com probabilidade 0,2. Sabe-se que P(B|C1)=1/2, P(B|C2)=1/3, P(B|C3)=1. Dado que saiu uma bola branca (evento B), calcule P(C3|B).   
A) 0,20   
B) 0,30   
C) 0,40   
D) 0,50   
...
E) (10  2)·(0,1)⁰·(0,9)¹⁰   
RESPOSTA: A  
• Para X ∼ b(n,p), P(X=k) \= (n  k) p^k (1−p)^(n−k).   
• Aqui n=10, p=0,1 e k=2.   
• Logo, P(X=2) \= (10  2)·(0,1)²·(0,9)⁸. 

QUESTÃO 163 \- 2   
Se X ∼ b(n,p) com n \= 20 e p \= 0,3, calcule E(X) e Var(X).   
A) E(X)=6; Var(X)=4,2   
B) E(X)=6; Var(X)=6   
C) E(X)=20; Var(X)=6   
D) E(X)=4,2; Var(X)=6   
E) E(X)=4,2; Var(X)=4,2   
RESPOSTA: A  
• Para a binomial, E(X)=np e Var(X)=npq, com q=1−p.   
• E(X)=20×0,3=6.   
• q=0,7 ⇒ Var(X)=20×0,3×0,7=4,2.

QUESTÃO 164 \- 2   
Se Z ∼ N(0,1), qual é a expressão da densidade φ(z)?   
A) φ(z)=√(2π)·e^(−z²/2)   
B) φ(z)=1/√(2π)·e^(−z²/2)   
C) φ(z)=1/(2π)·e^(−z/2)   
D) φ(z)=1/√(2π)·e^(−|z|/2)   
E) φ(z)=1/2·e^(−z²)   
RESPOSTA: B  
• A densidade da normal padrão é dada por φ(z)=1/√(2π)·e^(−z²/2). 

QUESTÃO 165 \- 3  
Coleta-se uma amostra de 10 observações independentes de uma N(2,2). Determine a probabilidade de a média amostral ser inferior a 1\.
...
RESPOSTA: A  
Aqui N(2,2) significa média μ=2 e variância σ^2 \= 2, então σ= raiz quadrada de 2\.  
Aplicando a fórmula do desvio padrão da média amostral:  
σ / raiz quadrada de n   
...
QUESTÃO 166 \- 3  
Um fabricante afirma que sua vacina contra gripe imuniza em 80% dos casos. Uma amostra de 25 indivíduos que tomaram a vacina foi sorteada e testes foram feitos para verificar a imunização ou não desses indivíduos. Se o fabricante estiver correto, qual é a probabilidade de a proporção de imunizados na amostra ser inferior a 0,75? 
...
QUESTÃO 167 \- 3  
De 50.000 válvulas fabricadas por uma companhia retira-se uma amostra de 400 válvulas, e obtém-se a vida média de 800 horas e o desvio padrão de 100 horas. Qual o intervalo de confiança de 95% para a vida média da população?
...
QUESTÃO 168 \- 3  
Suponha que estejamos interessados em estimar a proporção de consumidores de um certo produto. Se a amostra de tamanho 300 forneceu 100 indivíduos que consomem o dado produto, determine o intervalo de confiança para p, com coeficiente de confiança de 95%:
...
RESPOSTA: A  
Proporção amostral: p^ \= 100/300 \= 0.333  
...
QUESTÃO 169 \-3   
O nível de colesterol segue distribuição Normal com variância conhecida igual a 64 (mg/ml)². Uma amostra de 46 indivíduos apresentou média de 120  
...
QUESTÃO 170 \- 3  
O consumo médio de combustível de um modelo de automóvel tem desvio padrão conhecido igual a 2 km/l. Uma amostra de 40 veículos apresentou média de 9,3 km/l. Construa o intervalo de confiança de 94% para a média populacional. (Dado: z0,03=1,88)
...
QUESTÃO 171 \- 3   
Um intervalo de confiança de 95% para a média de uma população Normal com desvio padrão 2 foi construído com base em uma amostra de tamanho 100: (35,21;35,99). Qual foi o valor da média amostral?
...
QUESTÕES 173 \- 2   
Se X ∼ N(μ,σ²) com μ \= 50 e σ \= 10, qual transformação gera Z ∼ N(0,1)?   
A) Z=(X−50)/10   
B) Z=(X−10)/50   
C) Z=(50−X)/10   
D) Z=(X−50)/100   
E) Z=10(X−50)   
RESPOSTA: A  
• A padronização é Z \= (X−μ)/σ.   
• Com μ=50 e σ=10: Z \= (X−50)/10. 

QUESTÃO 174 \- 1  
Se X1,…,Xn são i.i.d. com média μ e variância σ², qual é Var(X̄)?   
A) σ²   
B) σ²/n   
C) nσ²   
D) σ²/(n−1)   
...
QUESTÕES 175 \- 2  
Deseja-se escolher n tal que P(|X̄ − μ| ≤ ε) \= γ, com σ conhecido. Qual expressão para n aparece no livro (em função de σ, ε e zγ)?   
A) n \= (σ/ε)·zγ   
B) n \= σ²·zγ/ε²   
C) n \= σ²·zγ²/ε²   
D) n \= (ε/σ)·zγ²   
E) n \= (σ²/ε)·zγ²   
RESPOSTA: C   
• Do desenvolvimento, usa-se Z \= (X̄−μ)√n/σ e P(−zγ \< Z \< zγ)=γ.   
• Resulta √n·ε/σ \= zγ. • Elevando ao quadrado: n \= σ²·zγ²/ε².

QUESTÕES 176 \- 3  
Uma amostra de n \= 25 tem X̄ \= 485\. Sabe-se que σ \= 10\. Construa o IC de 95% para μ.   
A) \]481; 489\[   
B) \]480; 490\[   
C) \]482; 488\[   
D) \]483; 487\[   
E) \]479; 491\[   
RESPOSTA: A   
• Para σ conhecido: IC(μ;0,95)= \]X̄ − 1,96·σ/√n ; X̄ \+ 1,96·σ/√n\[.   
• σ/√n \= 10/√25 \= 10/5 \= 2\.   
• IC \= \]485 − 1,96·2 ; 485 \+ 1,96·2\[ \= \]485 − 3,92 ; 485 \+ 3,92\[ \= \]481,08 ; 488,92\[.   
• Arredondando conforme apresentado no exemplo do livro: \]481; 489\[.

QUESTÕES 177 \- 3  
Um IC(μ;0,95) foi obtido como \]12,3; 15,7\[. Qual interpretação está correta? A) P(12,3 \< μ \< 15,7) \= 0,95 para este μ fixo.   
B) Em 95% das amostras, o intervalo construído conterá o μ verdadeiro.   
C) μ varia aleatoriamente e tem 95% de chance de cair no intervalo.   
D) O intervalo contém 95% dos dados da amostra.   
E) A amplitude do intervalo depende de X̄, mas não de n.   
RESPOSTA: B   
• μ é um parâmetro fixo; o intervalo é aleatório porque depende da amostra.   
• A interpretação frequencista: em repetições do procedimento, 95% dos intervalos conterão o verdadeiro μ.

QUESTÕES 178 \- 3   
Qual sequência corresponde aos passos gerais para construir um teste de hipóteses?   
A) Fixar RC → Fixar H0/H1 → Calcular estatística → Fixar α → Decidir   
B) Fixar H0/H1 → Escolher estatística → Fixar α e construir RC → Calcular estatística → Decidir   
C) Escolher estatística → Fixar H0/H1 → Fixar α → Calcular estatística → Construir RC   
D) Fixar α → Fixar H0/H1 → Decidir → Construir RC → Calcular estatística   
E) Construir RC → Fixar α → Fixar H0/H1 → Escolher estatística → Decidir RESPOSTA: B  
• Os passos são: (1) fixar H0 e H1; (2) escolher estatística e sua distribuição sob H0; (3) fixar α e construir RC; (4) calcular a estatística com os dados; (5) decidir comparando com a RC. 

QUESTÃO 179 \- 1  
 Um pesquisador deseja estudar a variável ”Renda Mensal” de um grupo de funcionários. Ao organizar os dados, ele percebe que a distribuição é fortemente assimétrica à direita (cauda longa para a direita). Segundo a abordagem de Bussab & Morettin, qual a relação esperada entre as medidas de posição?   
...
RESPOSTA: C  
Em distribuições assimétricas à direita, os valores extremos altos ”puxam” a média para cima. A moda é o valor mais frequente (pico da curva), e a mediana divide a área ao meio, ficando entre as duas.

QUESTÃO 180 \- 1  
Considere um conjunto de dados X \= {x1, x2, . . . , xn} com variância s^2 . Se multiplicarmos todos os valores do conjunto por uma constante k e somarmos uma constante c a cada valor, a nova variância será:   
A) s^2 \+ c   
B) k · s^2   
C) k^2 · s^2 \+ c   
D) k^2 · s^2   
E) k(s^2 \+ c)    
RESPOSTA: D  
Pela propriedade da variância, se Y \= kX \+ c, então Var(Y ) \= Var(kX \+ c) \= k^2Var(X). A constante aditiva c não altera a dispersão. 

QUESTÃO 181 \- 1  
No diagrama de caixa (Box-plot), a distância entre o primeiro e o terceiro quartil é definida como o Intervalo Interquartil (dq \= Q3 −Q1). Pela convenção usual adotada pelos autores, um valor é considerado um outlier (ponto discrepante) se:   
A) Estiver fora do intervalo \[Q1 − 1, 0 · dq ; Q3 \+ 1, 0 · dq\]   
B) Estiver fora do intervalo \[Q1 − 1, 5 · dq ; Q3 \+ 1, 5 · dq\]   
C) For maior que a Média \+ 2 Desvios Padrão.   
D) Estiver acima de Q3 ou abaixo de Q1.   
E) Estiver fora do intervalo \[Mínimo ; Máximo\].  
RESPOSTA: B  
Convenção de Tukey: os limites para detecção de outliers são Q1 −1, 5dq (limite inferior) e Q3 \+ 1, 5dq (limite superior).

QUESTÃO 182 \-  1  
Ao estudar a relação entre duas variáveis quantitativas X e Y , o Coeficiente de Correlação de Pearson (r) resultou em −0, 85\. Segundo os autores, este valor indica:   
A) Uma correlação linear nula.   
B) Uma correlação linear positiva e fraca.   
C) Uma correlação linear negativa e forte.   
D) Uma correlação não linear perfeita.   
E) Um erro de cálculo, pois r deve ser sempre positivo.   
RESPOSTA: C  
O coeficiente r varia de \-1 a 1\. Valores próximos de \-1 indicam uma correlação linear forte e negativa (inversamente proporcionais).

QUESTÃO 183 \- 2  
Para uma variável aleatória discreta, a função que dá P(X=x) para cada valor x chama-se:
...
QUESTÃO 184 \- 2   
Qual condição é obrigatória para uma função p(x) ser uma função de probabilidade de uma variável discreta? 
...
RESPOSTA: C  
Probabilidades não podem ser negativas e a soma total deve dar 1\. 

QUESTÃO 185 \- 2  
X assume valores 0,1,2 com p(0)=0,2; p(1)=k; p(2)=0,3. Qual é k para p(x) ser válida?
...
RESPOSTA: E  
A soma das probabilidades deve ser 1, logo:  
0,2 \+ k \+ 0,3 \= 1  
0,5 \+ k \= 1  
k \= 1 \- 0,5  
k \= 0,5  
QUESTÃO 186 \- 2   
Uma moeda honesta é lançada 3 vezes. Seja X o número de caras. Qual é P(X=2)?
...
RESPOSTA: C  
X segue Binomial com n=3 e p=1/2 (X\~Bin(3,1/2 )
...
QUESTÃO 187 \- 2  
 Em 4 lançamentos de moeda honesta, qual é P(X=0)?
...
RESPOSTA: D  
X segue Binomial com n=4 e p=1/2 (X\~Bin(4,1/2 )
...
QUESTÃO 188 \- 2   
Em 6 tentativas independentes com probabilidade de sucesso p=0,4, X\~Bin(6;0,4). Qual é P(X≤2)?
...
QUESTÃO 189 \- 2   
Em 8 tentativas com p=0,2, qual é P(X=3) para X\~Bin(8,0,2)?
...
RESPOSTA: C  
P(X=3) \= C(8,3) \* 0,2^3 \* 0,8^5   
\= 56 \* 0,008 \* 0,32768   
\= 56 \* 0,002621 \= 0,1468

QUESTÃO 190 \- 2  
Se X\~Binomial(n=10, p=0,5), então E(X) e Var(X) são, respectivamente:
...
QUESTÃO 191 \- 2   
A distribuição Exponencial é muito usada para modelar: 
...
RESPOSTA: B  
A exponencial modela tempo de espera (ex.: tempo até a falha de um dispositivo).

QUESTÃO 192 \- 2  
Se X\~Exponencial(λ=4), então E(X) e Var(X) são:
...
Var=1/16.  
QUESTÃO 193 \- 2  
Qual é uma característica típica da distribuição Normal? 
...
RESPOSTA: B  
A normal é uma curva contínua e simétrica em torno da média

QUESTÃO 194 \- 1  
No modelo de regressão linear simples Y \= α+βX+ ,ocoeficienteβ representa:   
A) O valor esperado de Y quando X \= 0\.   
B) A correlação entre X e Y.   
C) A alteração esperada em Y para cada unidade de aumento em X.   
D) O erro quadrático médio.   
E) A variância residual.  
RESPOSTA: C  
O β é o coeficiente angular. Ele mede a taxa de variação de Y em relação a X, ou seja, o quanto Y varia, em média, quando X aumenta em 1 unidade.

QUESTÃO 195 \- 1  
A variável ”Grau de Escolaridade” (Fundamental, Médio, Superior) é classificada como:   
...
E) Variável Dummy.  
RESPOSTA: B  
É qualitativa pois expressa um atributo, e ordinal pois existe uma hierarquia lógica (Fundamental \< Médio \< Superior).
...
C) P(A|B) \= P(B)   
D) P(A∩B)=P(A)·P(B)   
E) A e B forem mutuamente exclusivos.  
RESPOSTA: D  
Esta é a definição clássica de independência: a probabilidade da intersecção de dois eventos independentes é igual ao produto das suas probabilidades marginais.

QUESTÃO 197 \- 2  
Em uma urna há 5 bolas brancas e 3 pretas. Duas bolas são retiradas sucessivamente, sem reposição. Qual a probabilidade de a primeira ser branca e a segunda ser preta?    
A) 15/64   
B) 15/56   
C) 5/8   
D) 3/8   
E) 15/28  
RESPOSTA: B  
Sendo Eventos dependentes (sem reposição):   
P(B1∩P2) \= P(B1)·P(P2|B1) \= 5/8 · 3/7 \= 15/56.

QUESTÃO 198 \- 2  
Uma variável aleatória X segue uma distribuição de Bernoulli com parâmetro p \= 0,4. A variância de X, Var(X), é igual a:   
A) 0,40   
B) 0,60   
C) 0,24   
D) 0,16   
E) 1,00  
RESPOSTA: C  
Para a distribuição de Bernoulli, a variância é dada por Var(X) \= p · (1 − p). Logo, Var(X) \= 0,4·0,6 \= 0,24.

QUESTÃO 199 \- 2  
Uma central telefônica recebe, em média, 3 chamadas por minuto. Admitindo que a distribuição de Poisson é adequada para este caso, a probabilidade de não receber nenhuma chamada em um minuto específico é:   
A) e^−3   
B) 3·e^−3   
C) 1−e^−3   
D) e^3   
E) 3/e  
RESPOSTA: A  
No modelo de Poisson, P(X \= k) \= (e^−λ.λ^k)/k\! P(X \=0)= e^−3·3^0/0\! \= e^−3. k\! . Substituindo k \= 0 e a taxa λ \= 3: fica igual a e^-3.

QUESTÃO 200 \- 2  
Seja Z uma variável aleatória com distribuição Normal Padrão, Z ∼ N(0,1). Se desejamos encontrar um valor k tal que P(−k ≤ Z ≤ k)=0,95,qual o valor aproximado de segundo tabelas clássicas?   
A) 1,00   
B) 1,64   
C) 1,96   
D) 2,33   
E) 2,58  
RESPOSTA: C  
O intervalo que concentra 95% da probabilidade na Normal Padrão (Z) deixa 2, 5% em cada cauda. O valor crítico z correspondente na tabela é 1,96.

QUESTÃO 201 \- 2  
Uma moeda honesta é lançada 100 vezes. Para calcular a probabilidade de obter entre 45 e 55 “caras” usando a aproximação pela Normal, devemos considerar a variável contínua X ∼ N(µ,σ^2) com:    
A) µ \=50 e σ^2 \=50   
B) µ \=50 e σ^2 \=25   
C) µ \=100 e σ^2 \=50   
D) µ=0,5 e σ^2 \=0,25   
E) µ \=50 e σ^2 \=10  
RESPOSTA: B  
A aproximação normal tem os parâmetros: µ \= E(X) \= n·p \= 100·0,5 \= 50, e a variância σ^2 \= n·p·(1−p) \= 100·0,5·0,5 \= 25\.

QUESTÃO 202 \- 3  
A técnica de amostragem que consiste em dividir a população em grupos homogêneos e selecionar uma amostra aleatória de cada grupo é chamada de:   
...
RESPOSTA: D  
Esta é a exata definição de amostragem estratificada, muito útil para reduzir a variância dos estimadores quando as subpopulações (estratos) são distintas entre si.

QUESTÃO 203 \- 3  
Um estimador θ é dito ser não viesado (ou não viciado) para o parâmetro θ se:   
A) Sua variância for mínima.   
B) O limite de sua probabilidade convergir para θ.   
C) Seu valor esperado for igual ao parâmetro: E(θ) \= θ.   
D) Ele for calculado a partir de uma amostra grande (n \> 30).   
E) Sua distribuição for Normal.  
RESPOSTA: C  
Um estimador é dito não viesado quando sua esperança matemática(valor esperado) é exatamente igual ao verdadeiro valor do parâmetro populacional.

QUESTÃO 204 \- 3  
Para uma amostra de tamanho n \= 100 de uma população com desvio padrão conhecido σ \= 20, o erro padrão da média é:   
A) 20   
B) 2   
C) 0,2   
D) 200   
E) 10  
RESPOSTA: B  
 O erro padrão da média é dado por σ¯x \= σ/√ n . Substituindo: 20/√100 \= 20/10 \= 2\.

QUESTÃO 205 \- 3   
Deseja-se estimar a proporção de eleitores de um candidato com um erro máximo de 3% e confiança de 95% (z \= 1,96). Se não há informação prévia sobre a proporção (p), qual o tamanho amostral mínimo necessário?   
A) 400   
B) 1068   
C) 385   
D) 2500   
...
RESPOSTA:  
QUESTÃO 206 \-2  
Das variáveis abaixo descritas, assinale quais são binomiais  
...
RESPOSTA: C  
A 1 é binomial. A 2 só seria binomial se todas as urnas tivessem exatamente a mesma proporção de bolas e a 3 só seria binomial se a probabilidade de alguém ser contra fosse a mesma em todas as cidades e as escolhas independentes.

QUESTÃO 207 \- 2  
Se X \~ b(n, p), sabendo-se que E(X) \= 12 e σ2= 3, determine n e p
...
QUESTÃO 208 \- 2  
Numa central telefônica, o número de chamadas chega segundo uma distribuição de Poisson, com a média de oito chamadas por minuto. Determine qual a probabilidade de que num minuto se tenha 3 ou mais chamadas
...
RESPOSTA: B   
X∼Poisson(λ=8) e queremos calcular P(X≥3)  
...
QUESTÃO 209 \- 2  
Num certo tipo de fabricação de fita magnética, ocorrem cortes a uma taxa de um por 2.000 pés. Qual a probabilidade de que um rolo com 2.000 pés de fita magnética não tenha nenhum corte?
...
RESPOSTA: C  
A taxa é 1 corte a cada 2.000 pés, se o rolo tem 2.000 pés, então: λ=1  
Queremos calcular P(X=0), e para isso, usamos a fórmula:  
![][image37]  
P(X=0) \= 1^0 \* e^-1 / 0\! \= e^-1 \=  0,3679

QUESTÃO 210 \- 2  
Suponha que a probabilidade de que um item produzido por uma máquina seja defeituoso é de 0,2. Se dez itens produzidos por essa máquina são selecionados ao acaso, qual é a probabilidade de que não mais do que um defeituoso seja encontrado?
...
RESPOSTA: A  
X∼Bin(10;0,2), queremos encontrar P(X\<=1)  
P(X≤1) \= P(X=0) \+ P(X=1)  
...
QUESTÃO 211 \- 2  
Na manufatura de certo artigo, é sabido que um entre dez dos artigos é defeituoso. Qual a probabilidade de que uma amostra casual de tamanho quatro contenha exatamente um defeituoso?
...
RESPOSTA: C  
X∼Bin(4,0,1), queremos: P(X=1)  
Usando a fórmula:  
![][image38]  
P(X=1) \= C(4,1) \* 0,1^1 \* 0,9^3 \= 4 \* 0,1\* 0,9^3 \= 0,2916

QUESTÃO 212 \- 2  
Um fabricante de peças de automóveis garante que uma caixa de suas peças conterá, no máximo, duas defeituosas. Se a caixa contém 18 peças, e a experiência tem demonstrado que esse processo de fabricação produz 5% das peças defeituosas, qual a probabilidade de que uma caixa satisfaça a garantia?
...
RESPOSTA: A  
X∼Bin(18;0,05), queremos encontrar P(X≤2)  
...
QUESTÃO 213 \- 2  
Um curso de treinamento aumenta a produtividade de uma certa população de funcionários em 80% dos casos. Se dez funcionários quaisquer participam desse curso, encontre a probabilidade de exatamente sete funcionários aumentarem a produtividade?
...
RESPOSTA: B  
X∼Bin(10;0,8), queremos encontrar P(X=7)  
Usando a fórmula:  
![][image38]  
...
RESPOSTA: E  
X∼Poisson(λ=2), queremos calcular P(X\>3)   
